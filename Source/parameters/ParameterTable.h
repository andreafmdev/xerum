...
inline constexpr Spec kTable[kNumParams] = {
    ...
    { "drive", "Drive", "filter", Kind::Float, Map::Linear, 0.0f, 24.0f, 0.0f, 0.15f, "dB", 1, Label::None, nullptr, 0 },
    ...
    { "volume", "Volume", "master", Kind::Float, Map::Db, 0.0f, 1.0f, 6.0f, 0.8f, "dB", 1, Label::None, nullptr, 0 },
