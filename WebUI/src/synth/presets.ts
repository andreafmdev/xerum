...
/** Posizione e warp con cui disegnare la miniatura dell'onda: i valori del preset, o i default
    di spec per cio' che il preset non tocca (Init non tocca niente). */
export function presetWave(p: Preset): { pos: number; warp: number } {
  return {
