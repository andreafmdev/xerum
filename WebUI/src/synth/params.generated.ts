...
export const PARAM_SPECS: Record<ParamId, ParamSpec> = {
  ...
  "drive": {"id":"drive","name":"Drive","group":"filter","kind":"float","map":{"type":"linear","min":0,"max":24},"default":0.15,"unit":"dB","decimals":1},
  ...
  "volume": {"id":"volume","name":"Volume","group":"master","kind":"float","map":{"type":"db","min":0,"max":1,"offset":6},"default":0.8,"unit":"dB","decimals":1},
