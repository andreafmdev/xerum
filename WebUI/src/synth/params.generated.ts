...
export const PARAM_SPECS: Record<ParamId, ParamSpec> = {
  ...
  "wtIndex": {"id":"wtIndex","name":"Wavetable","group":"osc","kind":"choice","slot":false,"default":0,"options":[{"value":"basic","label":"Basic Shapes"},{"value":"saws","label":"Analog Saws"},{"value":"grit","label":"Digital Grit"},{"value":"vocal","label":"Vocal Formant"},{"value":"bells","label":"Glass Bells"},{"value":"pwm","label":"PWM Sweep"},{"value":"retro-racing","label":"Retro Racing"},{"value":"retro-ggsisters","label":"Retro GG Sisters"},{"value":"retro-commando","label":"Retro Commando"},{"value":"retro-uridium-pad","label":"Retro Uridium Pad"},{"value":"retro-leaderboard","label":"Retro Leaderboard"}]},
