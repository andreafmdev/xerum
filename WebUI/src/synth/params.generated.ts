...
export const PARAM_SPECS: Record<ParamId, ParamSpec> = {
  ...
  "warp": {"id":"warp","name":"Warp","group":"osc","kind":"float","slot":false,"map":{"type":"linear","min":0,"max":100},"default":0.1,"unit":"%","decimals":0},
  ...
  "voiceMode": {"id":"voiceMode","name":"Voice mode","group":"master","kind":"choice","slot":false,"default":0,"options":[{"value":"Poly","label":"Poly"},{"value":"Mono","label":"Mono"},{"value":"Legato","label":"Legato"}]},
  ...
  "glide": {"id":"glide","name":"Glide","group":"master","kind":"float","slot":false,"map":{"type":"ms-squared","min":0,"max":2000},"default":0,"unit":"ms","decimals":0},
  ...
  "envCurve": {"id":"envCurve","name":"Curve","group":"env","kind":"float","slot":false,"map":{"type":"linear","min":-100,"max":100},"default":0.5,"decimals":0,"labelKind":"signed","bipolar":true},
  ...
  "rvMix": {"id":"rvMix","name":"Mix","group":"fx2","kind":"float","slot":false,"map":{"type":"linear","min":0,"max":100},"default":0.25,"unit":"%","decimals":0},
  "arpOn": {"id":"arpOn","name":"Arp on","group":"arp","kind":"bool","slot":false,"default":false},
  "arpMode": {"id":"arpMode","name":"Arp mode","group":"arp","kind":"choice","slot":false,"default":0,"options":[{"value":"Up","label":"Up"},{"value":"Down","label":"Down"},{"value":"UpDn","label":"UpDn"},{"value":"Rand","label":"Rand"}]},
  "arpRate": {"id":"arpRate","name":"Rate","group":"arp","kind":"float","slot":false,"map":{"type":"linear","min":0,"max":1},"default":0.4,"labelKind":"arp-rate"},
  "arpGate": {"id":"arpGate","name":"Gate","group":"arp","kind":"float","slot":false,"map":{"type":"linear","min":0,"max":100},"default":0.6,"unit":"%","decimals":0},
  "arpOct": {"id":"arpOct","name":"Octaves","group":"arp","kind":"float","slot":false,"map":{"type":"linear","min":1,"max":4},"default":0.33,"decimals":0},
  "arpSwing": {"id":"arpSwing","name":"Swing","group":"arp","kind":"float","slot":false,"map":{"type":"linear","min":0,"max":100},"default":0,"unit":"%","decimals":0},
